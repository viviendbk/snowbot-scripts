...
function move()
    ...
    if ScriptStarting then
        ...
        elseif not hdvRunesChecked then
            ...
            if random == 1 then
                global:printSuccess("Update des runes")
                global:leaveDialog()
        ...
        elseif not hdvRessourceChecked2 then
            ...
            local json = openFile("C:\\Users\\Vivien\\Documents\\Snowbot-Scripts-3\\PC\\Scripts\\Craft\\" .. character:server() .. "\\Craft-Resell.json")
            local newTemp = {}
