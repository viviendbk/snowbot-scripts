...
-----------------------------------------------------------
-- This script is automatically generated by Snowcreator --
...
global:printMessage("[Info] Trajet créé par Antiko")

function debug_info()
	global:printSuccess("- Une fois à Astrub : placez-vous en [5,-18]")
end
