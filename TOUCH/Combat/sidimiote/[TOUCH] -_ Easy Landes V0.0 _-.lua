...
-----------------------------------------------------------
-- This script was made by Blacklister to farm les landes de sidimotes pour briser les bottes du mulou I used a simple IA lvl 200 to farm 
--  Make sure you got a brakmar teleportation potion on your account.
-----------------------------------------------------------

---------------------------------------------
-- Nom :      Brisage Bottes du mulou
...
global:printMessage("[Info] Trajet créé par Blacklister")

function debug_info()
	global:printSuccess("- Acheter une potion de teleportation vers Brakmar avant de lancer le script")
end

debug_info()

AUTO_DELETE = {}         -- Add the identifiers of the objects you want to delete (CF : https://www.snowbot.eu/objets.txt)
GATHER = {254;38;1;75}              -- Add the identifiers of the resources you want to harvest (CF : https://www.snowbot.eu/ressources.txt)
...
function move()
    return {
   {
	--[[-1,24]]    { map = "88212481", custom = function() inventory:useItem(6964) end, done = false },
	--[[-26,36]]   { map = "13631488", path = "490", done = false },
	--[[-26,36]]   { map = "144420", path = "top(6)", done = false },
	--[[-26,35]]   { map = "144419", path = "top(6)", done = false },
	--[[-26,34]]   { map = "144418", path = "top(6)", done = false },
	--[[-26,33]]   { map = "144417", path = "top(6)", done = false },
	--[[-26,32]]   { map = "144416", custom = function() map:moveToCell(35) map:moveToCell(21) end, path = "top(9)", done = false },
	--[[-26,31]]   { map = "144415", door = "125", done = false },
	--[[-25,30]]   { map = "143902", path = "top(11)", done = false },
	--[[-25,29]]   { map = "143901", path = "top(10)", done = false },
	--[[-25,28]]   { map = "143900", path = "top(11)", done = false },
	--[[-25,27]]   { map = "143899", path = "top(11)", done = false },
	--[[-25,26]]   { map = "143898", path = "top(10)", done = false },
	--[[-25,25]]   { map = "143897", path = "top(10)", done = false },
	--[[-25,24]]   { map = "143896", path = "top(10)", done = false },
	--[[-25,23]]   { map = "143895", path = "top(10)", done = false },
	--[[-25,22]]   { map = "143894", path = "top(11)", done = false },
	--[[-25,21]]   { map = "143893", path = "top(10)", done = false },
	--[[-25,20]]   { map = "143892", path = "top(10)", done = false },
	--[[-25,19]]   { map = "143891", path = "top(10)", done = false },
	--[[-25,18]]   { map = "143890", path = "top(10)", done = false },
	--[[-25,17]]   { map = "143889", path = "top(10)", done = false },
	--[[-25,16]]   { map = "143888", path = "top(11)", done = false },
	--[[-25,15]]   { map = "143887", path = "top(10)", done = false },
	--[[-25,14]]   { map = "143886", path = "top(10)", done = false },
	--[[-25,13]]   { map = "143885", path = "top(10)", done = false },
	--[[-25,12]]   { map = "143884", path = "right(251)", done = false },  
