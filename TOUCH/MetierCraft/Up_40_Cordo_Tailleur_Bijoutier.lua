...
local CraftCordonier = {
    {Name = "Bottes du Boufton", Id = 890, Type = "Bottes", ListIdCraft = {{Id = 303, Nb = 1}, {Id = 421, Nb = 1}}, PodsNeededToCraft = 6, NbToUp = 8000, LvlMaxMetier = 40}, --540 crafts pour up lvl20
}

local CraftBijoutier = {
    {Name = "Petite Amulette de l'Ours", Id = 74 , Type = "Amulette", ListIdCraft = {{Id = 473, Nb = 1}, {Id = 421, Nb = 1}}, PodsNeededToCraft = 6, NbToUp = 8000, LvlMaxMetier = 40}, 
}

local CraftTailleur = {
    {Name = "Bandeau Komintot", Id = 941, Type = "Chapeau", ListIdCraft = {{Id = 421, Nb = 2}, {Id = 289, Nb = 3}}, PodsNeededToCraft = 8, NbToUp = 8000, LvlMaxMetier = 40},
}
