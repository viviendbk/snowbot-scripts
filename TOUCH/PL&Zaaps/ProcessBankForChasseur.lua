...
AUTO_DELETE = {792, 519, 385, 1736, 385, 383, 2414, 2416, 2425, 2428, 10967, 1900, 364, 1730, 15479, 1690, 407, 1734, 2599}
...
local tableCraft = {
    ...
    {Name = "Cuisse de Bouftou Conservée", Id = 1995, Level = 10, ViandeId = 1911, MaxHdv100 = 3, MaxHdv10 = 15, ListIdCraft = {
        {Id = 1983, Nb = 1},
        {Id = 1986, Nb = 1},
    }, PodsNeededToCraft = 4},
...
local function SellViandesCraft()
    ...
    local Need = job:level(41) < 40 and 2 or 4
    global:editInMemory(global:thisAccountController():getAlias() .. " Need" .. Need)
    global:disconnect()
end
